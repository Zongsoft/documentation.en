...
| [Garnet (garnet)](garnet.md) | Run the Garnet server that supports the Redis protocol through the host [worker](https://github.com/Zongsoft/framework/blob/main/Zongsoft.Core/src/Components/IWorker.cs) | [Caching and Distributed Coordination](../caching.md) |
...
| [Polly (polly)](polly.md) | Add retry, timeout, circuit breaking, rate limiting, and fallback to the [Core](https://github.com/Zongsoft/framework/tree/main/Zongsoft.Core) execution pipeline to handle transient operation failures | [Task Scheduling and Resilient Execution](../execution.md) |
